...
/////Kênh Thingspeak////////////////
unsigned long myChannelNumber = 475231;   // Kênh trên Thingspeak
const char * myWriteAPIKey = "S18R1HLP2OY6ABY5"; // Mã cho phép ghi trên kênh
...
void loop() {
        ...
        if(Dem == 2) {
                ...
                ThingSpeak.setField(2,(float) MilLit);
