...
const char* ssid = "netis"; // your connection name
const char* password = "password"; // your connection password

ESP8266WebServer server(80);

int gpio1_pin = D4;  // D4 of nodemcu
int gpio2_pin = D3; // D7 of nodemcu
int gpio3_pin = D2; //  D5 of nodemcu
