...
char auth[] = "dbdea3a557864bd896dc7bb34cd1af2a"; //vkte10_2
...
BLYNK_WRITE(V27) //Bit_Timer_3
{
        bool pinValue = param.asInt(); // assigning incoming value from pin V14 to a variable
        Bit_Timer_3 = pinValue;         // đổi trạng thái
}
BLYNK_WRITE(V29) //Bit_Timer_4
{
        bool pinValue = param.asInt(); // assigning incoming value from pin V14 to a variable
...
BLYNK_WRITE(V26) {   // Scheduler #2 Time Input widget
...
BLYNK_WRITE(V28) {   // Scheduler #2 Time Input widget
