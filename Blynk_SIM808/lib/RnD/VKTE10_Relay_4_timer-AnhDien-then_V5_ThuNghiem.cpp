...
#define TRUE          1
#define FALSE         0
#define CheckConnection_Period 5000   // In milliseconds
// You should get Auth Token in the Blynk App.
// Go to the Project Settings (nut icon).
char auth[] = "4a1476b3bc88499caeb85638dc23a748"; // vkte10(3)
...
BLYNK_WRITE(V12) {   // Scheduler #2 Time Input widget
        ...
        if (stopseconds_2 > startseconds_2) {
                delta_time_2 = stopseconds_2 - startseconds_2;
        } else if (stopseconds_2 <= startseconds_2) {
                delta_time_2 = startseconds_2 + 86400 - stopseconds_2;
        }
...
BLYNK_WRITE(V13) {   // Scheduler #3 Time Input widget
        ...
        if (stopseconds_3 > startseconds_3) {
                delta_time_2 = stopseconds_3 - startseconds_3;
        } else if (stopseconds_3 <= startseconds_3) {
                delta_time_2 = startseconds_3 + 86400 - stopseconds_3;
        }
...
BLYNK_WRITE(V14) {   // Scheduler #4 Time Input widget
        ...
        if (stopseconds_4 > startseconds_4) {
                delta_time_2 = stopseconds_4 - startseconds_4;
        } else if (stopseconds_4 <= startseconds_4) {
                delta_time_2 = startseconds_4 + 86400 - stopseconds_4;
        }
...
void activetoday(){         // check if schedule #1 or #2 should run today
        ...
        if(nowseconds >= startseconds_2  && nowseconds <= startseconds_2 + delta_time_2  && Bit_Timer == TRUE) {                   // 62s on 60s timer ensures 1 trigger command is sent
        ...
        if(nowseconds >= stopseconds_2 && nowseconds <= stopseconds_2 + 20 && Bit_Timer == TRUE ) {         // 62s on 60s timer ensures 1 trigger command is sent
        ...
        if(nowseconds >= startseconds_3  && nowseconds <= startseconds_3 + delta_time_3  && Bit_Timer == TRUE) {                   // 62s on 60s timer ensures 1 trigger command is sent
        ...
        if(nowseconds >= stopseconds_3 && nowseconds <= stopseconds_3 + 20 && Bit_Timer == TRUE ) {         // 62s on 60s timer ensures 1 trigger command is sent
        ...
        if(nowseconds >= startseconds_4  && nowseconds <= startseconds_4 + delta_time_4  && Bit_Timer == TRUE) {                   // 62s on 60s timer ensures 1 trigger command is sent
        ...
        if(nowseconds >= stopseconds_4 && nowseconds <= stopseconds_4 + 20 && Bit_Timer == TRUE ) {         // 62s on 60s timer ensures 1 trigger command is sent
