...
#define DHTPIN PB_2     // Chân DATA nối với PB2
...
// const char SSID[] = "TP-LINK_B7EA18";
// const char SSID_KEY[] = "66668888";
// const char BSSID[] = "64:66:b3:b7:ea:18";
...
char cmd_buff[150];
int8_t cmd_length = 0;
unsigned long interval=5000; // Thời gian delay lấy mẫu
...
boolean connect_Server(){
        memset(cmd_buff, '\0', 150); //Đặt lại giá trị của cmd_buff
        // // Bật chế độ đa kết nối
        // sendATcommand("AT+CIPMUX=1", "OK", 5000);
